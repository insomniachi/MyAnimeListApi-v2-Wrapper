...
public class AnimeFieldNames
{
    ...
    public const string NumberOfUsers = "num_list_users";
    public const string NumberOfScoringUsers = "num_scoring_users";
    ...
    public const string RelatedManga = "related_managa";
